...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3 
    */
    GPIO_InitStruct.Pin = CH1_KKM_LOW_TIM1CH1N_Pin|CH1_KKM_HIGH_TIM1CH1_Pin|CH2_KKM_LOW_TIM1CH2N_Pin|CH2_KKM_HIGH_TIM1CH2_Pin 
                          |CH3_KKM_LOW_TIM1CH3N_Pin|CH3_KKM_HIGH_TIM1CH3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE15     ------> TIM1_BKIN 
    */
    HAL_GPIO_DeInit(GPIOE, CH1_KKM_LOW_TIM1CH1N_Pin|CH1_KKM_HIGH_TIM1CH1_Pin|CH2_KKM_LOW_TIM1CH2N_Pin|CH2_KKM_HIGH_TIM1CH2_Pin 
                          |CH3_KKM_LOW_TIM1CH3N_Pin|CH3_KKM_HIGH_TIM1CH3_Pin|GPIO_PIN_15);
